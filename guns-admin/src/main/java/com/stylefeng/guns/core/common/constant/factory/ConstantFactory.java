...
public class ConstantFactory implements IConstantFactory {
    ...
    private AreaTagMapper areaTagMapper = SpringContextHolder.getBean(AreaTagMapper.class);
    ...
    public String getCityName(Integer cityId) {
        AreaTag areaTag = areaTagMapper.selectById(cityId);
        if (areaTag != null) {
            return areaTag.getName();
        } else {
            return "--";
        }
    }
    ...
    public String getProvinceName(Integer provinceId) {
        AreaTag areaTag = areaTagMapper.selectById(provinceId);
        if (areaTag != null) {
            return areaTag.getName();
        } else {
            return "--";
