...
MgrUser.initColumn = function () {
    var columns = [
        ...
        {title: '省', field: 'provinceName', align: 'center', valign: 'middle', sortable: true},
        {title: '市', field: 'cityName', align: 'center', valign: 'middle', sortable: true}
...
MgrUser.onClickArea = function (e, treeId, treeNode) {
    MgrUser.city = treeNode.id;
    MgrUser.search();
};
...
$(function () {
    ...
    var citytree = new $ZTree("areaTree", "/areaTag/tree");
    citytree.bindOnClick(MgrUser.onClickArea);
    citytree.init();
});
