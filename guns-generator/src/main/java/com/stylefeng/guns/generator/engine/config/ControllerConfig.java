...
public class ControllerConfig {
    ...
    public void init() {
        ...
        imports.add("org.springframework.controller.bind.annotation.RequestMapping");
        imports.add("org.springframework.controller.bind.annotation.ResponseBody");
        imports.add("org.springframework.ui.Model");
        imports.add("org.springframework.controller.bind.annotation.PathVariable");
        imports.add("org.springframework.beans.factory.annotation.Autowired");
        imports.add(contextConfig.getProPackage() + ".core.log.LogObjectHolder");
        imports.add("org.springframework.controller.bind.annotation.RequestParam");
